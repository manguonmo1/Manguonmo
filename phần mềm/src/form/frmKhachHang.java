...
// Dinh dang lai hien thi thong tin ngay gio ra man hinh
    ...
    private void btnThem_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThem_ActionPerformed
        ...
        SDT = txtSDT.getText();
        LoaiKhachHang =     quang.quang_hao.frmTC.GetCbbSelected(cbbLoaiKhachHang);
        ...
        if (kiemtra) {
           ...
           quang.quang_hao.frmTC.layDuLieuKhachHang();
             quang.quang_hao.frmTC.SetCbbKhachHangfrm(txtTenKhachHang.getText());
...
public boolean KiemTraNhapKhachHang(int ts) {
        ...
        if (ThongBao.equals("")) {
            ...
            kiemtra = false;
            quang.quang_hao.frmTC.ThongBao(ThongBao, "lỗi nhập liệu", 2);
        }
        return kiemtra;
    }
...
int tam=0;
    ...
    private void jPanel_KhachHangComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel_KhachHangComponentShown
        ...
        quang.quang_hao.frmTC.layDuLieuKhachHang();
        cbbLoaiKhachHang.setModel(  quang.quang_hao.frmTC.LayDuLieucbb("LoaiKhachHang", "TenLoaiKhachHang", "MaLoaiKhachHang"));
        for (int i = 1; i < 32; i++) {
            cbbNgay.addItem(String.valueOf(i));
        }
        for (int i = 1; i < 13; i++) {
